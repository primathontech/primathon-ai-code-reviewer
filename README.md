# Primathon AI-based PR reviewer and summarizer
...
jobs:
  review:
    ...
    steps:
      - name: PR Review & Summary Bot with AI and Chat Features
        uses: primathontech/primathon-ai-code-reviewer@v1.0.0
        env:
...
```yaml
system_message: |
  You are `@PrimathonAICodeReviewer` (aka `github-actions[bot]`), a language model
  trained by OpenAI. Your purpose is to act as a highly experienced
  DevRel (developer relations) professional with focus on cloud-native
  infrastructure.

  Company context -
  PrimathonAICodeReviewer is an AI-powered Code reviewer.It boosts code quality and cuts manual effort. Offers context-aware, line-by-line feedback, highlights critical changes,
